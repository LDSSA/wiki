...
You can recruit internally in a public slack channel, [open an issue on the Wiki](https://github.com/LDSSA/wiki/issues) or externally following [the guidelines](pages/Recruiting-and-Onboarding-New-Instructors.md). Do it, it’s fun.

## Commitment to Code of Conduct
**I have actually read and agree to follow the [code of conduct](pages/Code-of-Conduct.md)**. The same code of conduct applies to everyone no matter what role they play in the organization.
